...
const Navbar = () => {
  ...
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <Link to={"signup"} className="inline-flex items-center bg-indigo-500 border-0 py-1 px-3 focus:outline-none text-white hover:bg-indigo-600 rounded text-base mt-4 md:mt-0 mr-5">Sign Up
