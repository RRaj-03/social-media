...
const Post = (props) => {
  ...
  return (
    ...
    <div className=" bg-white rounded-lg border shadow-md mt-4">
                <div className="flex flex-col justify-between p-10 pb-4 leading-normal">
                    <div className='flex justify-between mb-4'>
                        <div className="inline-flex items-center">
                            ...
                            <span className="flex-grow flex flex-col pl-3">
                                ...
                                <span className="text-gray-500 text-sm">{date.toString()}</span>
                            </span>
                        </div>
                        <div className='w-fit flex items-center justify-center'>
                            <button className="inline-flex items-center bg-indigo-500 border-0 py-1 px-3 focus:outline-none text-white hover:bg-indigo-600 rounded text-base mt-4 md:mt-0 mr-5 h-fit" onClick={()=>{
